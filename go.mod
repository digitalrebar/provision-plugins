module github.com/digitalrebar/provision-plugins/v4
...
require (
	...
	github.com/digitalrebar/provision/v4 v4.0.0-pre17
...
replace github.com/digitalrebar/provision/v4 => github.com/rackn/provision/v4 v4.0.0-pre17
